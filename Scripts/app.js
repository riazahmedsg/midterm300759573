...
function displaydata() 
{
    ...
    //function OutputFormDataToConsole() {
        ...
        console.log(`%c Email Address  : ${email.value}`, "color: blue;");
        ...
        SendButton.addEventListener("click", displaydata); }
